  ...
  setup(props, context) {
    ...
    const tiny = reactive({
      ...
      init: {
        ...
        plugins: [
          "link", "fullscreen", "autolink", "lists", "table",
          "image", "charmap", "codesample", "link", "advlist", "help"]
        ,
        toolbar: [
          "undo redo | alignleft aligncenter alignright alignjustify outdent indent | codesample table image charmap hr | help fullscreen ",
          "formatselect | bold italic underline strikethrough forecolor backcolor | bullist numlist subscript superscript removeformat",
